...
void setup() {
  ...
  Axis1.attach(2, 500, 2400); 
  
  Axis2.attach(32); Axis3.attach(33); Axis4.attach(34); Axis5.attach(35); Axis6.attach(36); //Axises attaching to pins
...
void loop() {
  ...
  if (SerialBT.available() > 0) {
   ...
   //Serial.println(Marked_servo);
    ...
    if(Marked_servo == "s1"){    
      Serial.print("--> S1--->");
      Serial.print("angle_from_Bluetooth: ");
