...
void setup() {
  ...
  Axis1.setPeriodHertz(50);    // standard 50 hz servo
  Axis2.setPeriodHertz(50);    // standard 50 hz servo
  Axis3.setPeriodHertz(50);    // standard 50 hz serv    // standard 50 hz servo
  // Recommended PWM GPIO pins on the ESP32 include 2,4,12-19,21-23,25-27,32-33 


  //Axises attaching to pins
  Axis1.attach(15, 500, 2400); 
  Axis2.attach(2, 500, 2400); 
  Axis3.attach(4, 500, 2400);  
  Axis4.attach(5, 500, 2400);  
  Axis5.attach(22, 500, 2400);  
  Axis6.attach(23, 500, 2400);  
...
void loop() {
  ...
  if (SerialBT.available() > 0) {
   ...
   //Serial.println(Marked_servo);
    ...
    if(Marked_servo == "s2"){
      if (angle_from_Bluetooth>100){angle_from_Bluetooth=100;}      
    ...
    if(Marked_servo == "s6"){
      if (angle_from_Bluetooth>90){angle_from_Bluetooth=90;}       
...
// THE PATH MODE  
if(data_from_Bluetooth.substring(0,7) == "THEPATH"){
   Serial.println("thepaaaaaaaa");
    //Do the path between points
        number_of_repeatings_the_path_String = data_from_Bluetooth.substring(7,data_from_Bluetooth.length());
...
void Save_pos(int NumPos){ 
  Axis1Pos_saved[NumPos] = current_posAxis1;
  Axis2Pos_saved[NumPos] = current_posAxis2;
  Axis3Pos_saved[NumPos] = current_posAxis3;
  Axis4Pos_saved[NumPos] = current_posAxis4;
  Axis5Pos_saved[NumPos] = current_posAxis5;
  Axis6Pos_saved[NumPos] = current_posAxis6;
  Axises_saved[NumPos] = true;
  }
  
void Move_to_saved_positions(int NumPos){
  AXIS1_func(Axis1Pos_saved[NumPos],20);
  delay(500);
  AXIS2_func(Axis2Pos_saved[NumPos],20);
  delay(500);
  AXIS3_func(Axis3Pos_saved[NumPos],20);
  delay(500);
  AXIS4_func(Axis4Pos_saved[NumPos],10);
  delay(500);
  AXIS5_func(Axis5Pos_saved[NumPos],20);
  delay(500);
  AXIS6_func(Axis6Pos_saved[NumPos],20);
  delay(500);
  }
...
//a
  ...
  Axises_saved[0]=true;
//b
  Axis1Pos_saved[1]=180;
  Axis2Pos_saved[1]=100;
  Axis3Pos_saved[1]=45;
  Axis4Pos_saved[1]=45;
  Axis5Pos_saved[1]=0;
  Axis6Pos_saved[1]=90;
  Axises_saved[1]=true;
//c
  Axis1Pos_saved[2]=180;
  Axis2Pos_saved[2]=100;
  Axis3Pos_saved[2]=45;
  Axis4Pos_saved[2]=45;
  Axis5Pos_saved[2]=0;
  Axis6Pos_saved[2]=90;
  Axises_saved[2]=true;
//d
  Axis1Pos_saved[3]=180;
  Axis2Pos_saved[3]=100;
  Axis3Pos_saved[3]=45;
  Axis4Pos_saved[3]=45;
  Axis5Pos_saved[3]=90;
  Axis6Pos_saved[3]=90;
  Axises_saved[3]=true;
//e
  Axis1Pos_saved[4]=180;
  Axis2Pos_saved[4]=100;
  Axis3Pos_saved[4]=45;
  Axis4Pos_saved[4]=45;
  Axis5Pos_saved[4]=90;
  Axis6Pos_saved[4]=20;
